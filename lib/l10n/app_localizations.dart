...
class AppLocalizations {
  ...
  static final Map<String, Map<String, String>> _localizedValues = {
    'en': {
      ...
      'saveChecklistChanges': 'Save Changes',
      ...
      'deleteChecklistConfirm':
          'Delete this custom checklist and all its spots? This cannot be undone.',
      'editSpot': 'Edit Spot',
      'deleteSpot': 'Delete Spot',
      'deleteSpotConfirm':
          'Delete this custom spot from the checklist? This cannot be undone.',
      'spotCountSingle': '1 spot',
      'spotCountPlural': '{count} spots',
    ...
    'zh': {
      ...
      'deleteChecklistConfirm': '删除这个自定义清单以及下面所有景点？此操作不可撤销。',
      'editSpot': '编辑景点',
      'deleteSpot': '删除景点',
      'deleteSpotConfirm': '从清单中删除这个自定义景点？此操作不可撤销。',
      'spotCountSingle': '1 个景点',
      'spotCountPlural': '{count} 个景点',
